...
public class SubMenuAcceso {
    ...
    private static void menuRegistrarEntrada(Scanner scanner) {
        ...
        do {
            ...
            System.out.println("2. Generar Información de Entrada");
    ...
    private static void asignarEspacio(Scanner scanner) {
        System.out.print("Ingrese el número del espacio a asignar: ");
        int espacio = scanner.nextInt();
        scanner.nextLine(); // Consumir la línea pendiente

        if (validacion.validarEspacio(espacio)) {
    ...
    private static void generarEntrada(Scanner scanner) {
        ...
        if (cuenta != null) {
            ...
            System.out.println("Cédula: " + cuenta.getCedula());
        } else {
